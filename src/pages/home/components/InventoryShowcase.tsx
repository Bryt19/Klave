...
export default function InventoryShowcase() {
  ...
  return (
    <section ref={containerRef} id="features" className="relative mt-12 pt-20 sm:pt-28 lg:pt-36 pb-14 sm:pb-20 lg:pb-28 bg-slate-50   overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Reveal delay={0.15}>
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden bg-white  border border-slate-200  dashboard-shadow">
            <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-slate-100 ">
              ...
              <div className="hidden sm:flex items-center gap-2">
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-50  border border-slate-200  text-[11px] text-slate-500 ">
            ...
            <div className="divide-y divide-slate-50 ">
              ...
              {inventoryMedicines.map((med, i) => (
                <motion.div
                  ...
                  className="grid grid-cols-1 sm:grid-cols-12 gap-2 sm:gap-3 px-5 sm:px-6 py-3 hover:bg-slate-50   transition-colors"
                >
          ...
          <div className="mt-8 sm:mt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                ...
                { step: "03", icon: "ri-alarm-warning-line", title: "Smart Alerts", desc: "Proactive notifications for low-stock thresholds, approaching expiry dates, and unusual consumption patterns, delivered via dashboard and email.", color: "bg-amber-50  text-amber-500 border-amber-100 ", accent: "border-amber-200/60" },
