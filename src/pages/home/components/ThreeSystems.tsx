        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            <Reveal>
              ...
              <p className="text-base text-slate-600 font-normal leading-relaxed max-w-md mb-8">
          ...
          <div className="lg:col-span-7 space-y-8 sm:space-y-10">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-3xl p-6 sm:p-8 organic-card-mesh border border-emerald-100/80 shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="flex items-center justify-between gap-4 mb-4">
                  <div className="flex items-center gap-2.5">
                    <span className="w-7 h-7 rounded-lg bg-emerald-950 text-white text-xs font-bold font-mono flex items-center justify-center">
                      1
                    </span>
                  ...
                  <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-emerald-100/90 text-emerald-800 border border-emerald-200">
                    99.4% OCR Confidence
                  </span>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 border border-slate-200/80 shadow-xs space-y-3">
                  <div className="flex items-center justify-between pb-2.5 border-b border-slate-100 text-xs">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono">Parsed in 340ms</span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                    ...
                    <div className="p-2 rounded-lg bg-slate-50 border border-slate-100">
                      <div className="text-[10px] text-slate-400">Dosage Qty</div>
                  ...
                  <div className="flex items-center justify-between text-[11px] pt-1 text-slate-500">
                    <span className="flex items-center gap-1">
                      <i className="ri-check-line text-emerald-600 font-bold" /> Doctor signature verified
                    </span>
                    <span className="text-emerald-700 font-medium cursor-pointer hover:underline">View original scan →</span>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="rounded-3xl p-6 sm:p-8 organic-emerald-card border border-emerald-200/80 shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="flex items-center justify-between gap-4 mb-4">
                  <div className="flex items-center gap-2.5">
                    <span className="w-7 h-7 rounded-lg bg-emerald-950 text-white text-xs font-bold font-mono flex items-center justify-center">
                      2
                  ...
                  <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-emerald-600 text-white">
                    FEFO Automated
                  </span>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 border border-slate-200/80 shadow-xs space-y-2.5">
                  <div className="flex items-center justify-between text-xs pb-2 border-b border-slate-100">
                    <span className="font-semibold text-slate-800">Batch Allocation Matrix</span>
                    <span className="text-[10px] text-slate-400">Stock Location: Shelf B-04</span>
                  </div>

                  {[
                    { batch: "BT-8841-A", expiry: "Dec 2026", stock: "450 units", status: "Priority FEFO", highlight: true },
                    { batch: "BT-9204-B", expiry: "Aug 2027", stock: "1,200 units", status: "Secondary Stock", highlight: false },
                  ].map((row) => (
                    <div
                      key={row.batch}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-[11px]">{row.stock}</span>
            ...
            <Reveal delay={0.3}>
              <div className="rounded-3xl p-6 sm:p-8 organic-card-mesh border border-emerald-100/80 shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="flex items-center justify-between gap-4 mb-4">
                  ...
                  <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-slate-900 text-white">
                    Audit-Ready Logs
                  </span>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 border border-slate-200/80 shadow-xs space-y-3">
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold text-slate-800">Pharmacist Verification Console</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-1 text-xs">
                    ...
                    <button className="px-3 py-1 bg-emerald-950 hover:bg-emerald-900 text-white rounded-lg text-xs font-semibold transition-colors shadow-xs">
                      Sign &amp; Release
                    </button>
                  </div>
                </div>
