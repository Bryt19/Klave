      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-10">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-3xl p-5 sm:p-8 organic-card-mesh border border-emerald-100  shadow-sm transition-all duration-300 hover:shadow-md">
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-slate-200  shadow-xs space-y-2 sm:space-y-3">
            ...
            <Reveal delay={0.2}>
              <div className="rounded-3xl p-5 sm:p-8 organic-emerald-card border border-emerald-200/80 shadow-sm transition-all duration-300 hover:shadow-md">
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-2xl p-2.5 sm:p-4 border border-slate-200  shadow-xs space-y-1.5 sm:space-y-2.5">
            ...
            <Reveal delay={0.3}>
              <div className="rounded-3xl p-5 sm:p-8 organic-card-mesh border border-emerald-100  shadow-sm transition-all duration-300 hover:shadow-md">
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-2xl p-2.5 sm:p-4 border border-slate-200  shadow-xs space-y-2 sm:space-y-3">
