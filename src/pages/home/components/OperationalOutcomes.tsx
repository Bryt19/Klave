...
export default function OperationalOutcomes() {
  return (
    <section className="relative py-24 md:py-32 bg-slate-50  transition-colors duration-200">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6">
            <Reveal>
              <div className="rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 h-full flex flex-col justify-between border border-slate-200  shadow-md bg-white ">
                <div>
