...
export default function BuiltForTeams() {
  return (
    <section className="relative py-16 sm:py-24 md:py-32 bg-white  transition-colors duration-300">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-24 md:mb-32">
          ...
          <div className="lg:col-span-7">
            <Reveal>
              <div className="glass-panel-clean rounded-3xl p-5 sm:p-6 shadow-xl border border-slate-200  bg-slate-50 ">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={idx} className="p-3 rounded-2xl bg-white  border border-slate-200  shadow-2xs space-y-2">
        ...
        <div id="integrations" className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-24 md:mb-32 scroll-mt-24">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <Reveal delay={0.1}>
              <div className="glass-panel-clean rounded-3xl p-5 sm:p-6 shadow-xl border border-slate-200  bg-white ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {builtForTeams.map((role, idx) => (
              <Reveal key={role.title} delay={idx * 0.08}>
                <motion.div
                  whileHover={{ y: -4 }}
                  className="subtle-card p-6 rounded-2xl h-full flex flex-col justify-between bg-white  border border-slate-200 "
                >
                  <div>
