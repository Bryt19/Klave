              ...
              <div className="grid grid-cols-3 gap-3 pt-5 mt-5 border-t border-slate-100 ">
                {[
                  ...
                  <div key={stat.label} className="text-center p-3 rounded-xl bg-blue-50/50  border border-blue-100/60 ">
                    <div className="text-base font-bold text-blue-500 ">{stat.value}</div>
            ...
            <div className="relative pl-8 sm:pl-10">
              ...
              {expiryItems.map((item, i) => {
                const severityColors: Record<string, { dot: string; bg: string; border: string; text: string }> = {
                  critical: { dot: "bg-red-400", bg: "bg-red-50 ", border: "border-red-100 ", text: "text-red-600 " },
                  warning: { dot: "bg-amber-400", bg: "bg-amber-50 ", border: "border-amber-100 ", text: "text-amber-600 " },
                  normal: { dot: "bg-emerald-400", bg: "bg-emerald-50 ", border: "border-emerald-100 ", text: "text-emerald-600 " },
                };
