          ...
          <div className="mx-auto max-w-3xl pointer-events-auto">
            <div className="flex items-center justify-between gap-4 px-5 py-3 rounded-2xl bg-slate-900/95 backdrop-blur-xl border border-white/[0.08] shadow-[0_8px_40px_rgba(0,0,0,0.35)]">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <a href={DEMO_URL} className="px-5 py-2 text-[11px] font-bold bg-emerald-50  hover:bg-emerald-400 text-white rounded-full transition-colors shadow-lg shadow-emerald-500/25">
                  Get Started Free
                </a>
              </div>
            </div>
