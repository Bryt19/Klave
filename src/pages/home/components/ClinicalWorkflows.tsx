...
export default function ClinicalWorkflows() {
  return (
    <section data-nav-theme="dark" id="solutions" className="relative py-14 sm:py-20 md:py-24 overflow-hidden dark-radar-section">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-50  rounded-full blur-3xl pointer-events-none" />
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 p-3 rounded-xl bg-red-950/60 border border-red-500/30 text-red-200 mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-lg bg-red-50  text-red-400 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <div className="text-xs font-bold text-red-100 flex items-center gap-2">
                      ...
                      <span className="text-[10px] uppercase tracking-wider font-semibold px-2 py-0.2 rounded-full bg-red-50  text-red-300 border border-red-500/30">
                        High Risk
                      </span>
                    </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 pt-3 border-t border-emerald-900/50">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  <button className="w-full sm:w-auto px-4 py-2 text-xs font-semibold rounded-full bg-emerald-50  hover:bg-emerald-400 text-emerald-950 transition-colors">
