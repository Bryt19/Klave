    ...
    <section id="features" className="relative py-16 sm:py-24 md:py-32 bg-slate-50 dark:bg-slate-800/50 transition-colors duration-200">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-14 md:mb-16 text-left">
          <Reveal>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.15] mb-4">
          ...
          {everyLayerFeatures.map((feature, i) => {
            ...
            return (
              <Reveal key={feature.title} delay={i * 0.05}>
                <motion.div
                  whileHover={{ y: -3 }}
                  className="subtle-card p-6 rounded-2xl h-full flex flex-col justify-between bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/80"
                >
                  <div>
                  ...
                  <div className={`mt-4 pt-3 border-t border-slate-100 dark:border-slate-700/50 flex items-center text-[11px] font-semibold ${
